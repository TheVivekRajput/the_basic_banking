...
<!-- main body of transfer money -->
<div class="container">
        <h2 class="text-center pt-4" style="color : purple;">Transfer Money</h2>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr style="color : black;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : indianred;">Transact</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
