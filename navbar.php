...
<nav class="navbar navbar-expand-md navbar-dark bg-light">
      <a class="navbar-brand" href="index.php" style="color : black;"><b> The Basic Bank Management</b></a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="create.php" style="color : black;"><b>Create User</b></a>
              </li>
              <li class="nav-item">
